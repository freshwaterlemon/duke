...
public class Pakipaki {
    ...
    // private static Task findTaskByDescription(String description, boolean
    // doneStatus, boolean findFromEnd)
    ...
    // // check isDone in task obj, continue if task is found but already mark as
    // done
    // if (task.getDescription().equalsIgnoreCase(description) && task.getIsDone()
    // == doneStatus) {
    // return task;
    // }
    // }
    ...
    // */
    // private static Task findTaskByDescription(String description) throws
    // PakipakiException {
    // try {
    ...
    // throw new PakipakiException("Task with description \"" + description + "\"
    // not found.");
    // }
    ...
    // task.markAsDone();
    // System.out.println(("Alright! \"" + taskString + "\" mark as
    // done!").indent(4));
    // System.out.println((task + "\n").indent(8));
    // storage.saveTasksToStorage(taskList); // mark and save new tasklist to
    // tasks.txt
    ...
    // System.out.println((task + "\n").indent(8));
    // storage.saveTasksToStorage(taskList); // unmark and save new tasklist to
    // tasks.txt
    // } catch (PakipakiException e) {
    // System.out.println((e.getMessage() + "\n").indent(4));
    // }
    ...
    // storage.saveTasksToStorage(taskList); // add and save new tasklist to
    // tasks.txt
    // }
    ...
    // ui.printMessage(("Please use the format: deadline <task> /by
    // <date/time>").indent(4));
    // }
    // }
    ...
    // ui.printMessage(("Please use the format: event <task> /from <date/time> /to
    // <date/time>").indent(4));
    // }
    // }
    ...
    // storage.saveTasksToStorage(taskList); // delete and save new tasklist to
    // tasks.txt
    // }
